...
public class Main extends Application{
    ...
    public void start(Stage stage) throws Exception {
        ...
        cap2S1.setTipo("Serie");
        cap3S1.setTipo("Serie");
        cap4S1.setTipo("Serie");
        cap5S1.setTipo("Serie");
        serie1.add(cap1S1);
        serie1.add(cap2S1);
        serie1.add(cap3S1);
        serie1.add(cap4S1);
        ...
        cap1S2.setTipo("Serie");
        cap2S2.setTipo("Serie");
        cap3S2.setTipo("Serie");
        cap4S2.setTipo("Serie");
        cap5S2.setTipo("Serie");
        serie2.add(cap1S2);
        serie2.add(cap2S2);
        serie2.add(cap3S2);
        serie2.add(cap4S2);
